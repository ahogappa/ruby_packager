...
a.out: /workspaces/ruby_packager/kompo_storage/src/lib.rs /workspaces/ruby_packager/kompo_wrap/src/lib.rs /workspaces/ruby_packager/kompo_fs/**/*.rs $(RUBY_LIB) $(PWD)/bundle/bundler/setup.rb main.c fs.c
		...
		main.c fs.c ruby/ext/extinit.o ruby/ext/cgi/escape/escape.a ruby/ext/continuation/continuation.a ruby/ext/coverage/coverage.a ruby/ext/date/date_core.a ruby/ext/digest/digest.a ruby/ext/digest/bubblebabble/bubblebabble.a ruby/ext/digest/md5/md5.a ruby/ext/digest/rmd160/rmd160.a ruby/ext/digest/sha1/sha1.a ruby/ext/digest/sha2/sha2.a ruby/ext/erb/escape/escape.a ruby/ext/etc/etc.a ruby/ext/fcntl/fcntl.a ruby/ext/fiddle/fiddle.a ruby/ext/io/nonblock/nonblock.a ruby/ext/io/wait/wait.a ruby/ext/json/generator/generator.a ruby/ext/json/parser/parser.a ruby/ext/monitor/monitor.a ruby/ext/objspace/objspace.a ruby/ext/openssl/openssl.a ruby/ext/pathname/pathname.a ruby/ext/psych/psych.a ruby/ext/pty/pty.a ruby/ext/rbconfig/sizeof/sizeof.a ruby/ext/ripper/ripper.a ruby/ext/socket/socket.a ruby/ext/stringio/stringio.a ruby/ext/strscan/strscan.a ruby/ext/zlib/zlib.a ruby/enc/encinit.o ruby/enc/libenc.a ruby/enc/libtrans.a -Wl,-rpath,/workspaces/ruby_packager/dest_dir/lib -L/workspaces/ruby_packager/dest_dir/lib \
		-L/workspaces/ruby_packager/target/debug \
